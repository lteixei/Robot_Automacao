...
public class CY0011_Migracao_Pre_Para_Pos_Controle_Plano_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Migracao_Pre_Para_Pos_Controle_Plano_LOJA_PROPRIA() throws InterruptedException{
	...
	// ######## NOVO ATENDIMENTO ########
        ...
        // ######## INSERIR CPF ########
        cenariostelas.setCPF("57014619632");
                        
     // ######## INSERIR TELEFONE ########
        String telcont = "15981110314";
	...
	// ######## ALTERAR CADASTRO ########
        ...
        cenariostelas.setDataEmissão("12/10/2020");
    ...
    // ######## LIMPAR MASSA ######## "BANCO" JENKINS
        String telcont1 = cenariostelas.ResgataMSISDN();
        String res="";
        try { res = JenkinsHelper.runJk_Limpar_Massa(cpf, telcont, chip );
        } catch (IOException e) {
                e.printStackTrace();
    ...
    //############# EVIDÊNCIAS #############
        ...
        System.out.print("MSISDN : " + telcont + "\n");
