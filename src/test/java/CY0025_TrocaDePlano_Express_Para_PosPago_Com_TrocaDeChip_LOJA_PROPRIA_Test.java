...
public class CY0025_TrocaDePlano_Express_Para_PosPago_Com_TrocaDeChip_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
    ...
    private String ResgataCPF = "select get_cpf_antigo('PLN', '','%TIM Controle G Express 5 0%', 'CPF','Ativo','11','') from dual " ; 
	...
	@Test
	public void test1_CY0025_TrocaDePlano_Express_Para_PosPago_Com_TrocaDeChip_LOJA_PROPRIA() throws InterruptedException{
    ...
    // ######## ATENDIMENTO ########
        cenariostelas.clickPlanoBlack_B_Express_2();
