...
public class CY0003_Ativacao_PosExpress_REVENDA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Ativacao_Controle_Express() throws InterruptedException{
    ...
    // ######## NOVO ATENDIMENTO ########
        cenariostelas.setCPF(cpf);
        cenariostelas.setTelefone("11981350604");//11983090018
        cenariostelas.proximoNovoAtendimento();
    ...
    // ######## DADOS COMPLEMENTARES ########
        ...
        cenariostelas.setTelContato("1131492458");
    ...
    // ######## PLANOS ########
        cenariostelas.clickPlanoBlack_A_Express_5_1();
   ...
   // ######## LIMPAR MASSA ######## "BANCO" JENKINS
    ...
    // ######## CARTÃO DE CRÉDITO ########
        cenariostelas.setNumeroCartao("5439545259363319");
        cenariostelas.clickMesValidade();
        cenariostelas.escolhaMesValidade();// 11
        cenariostelas.clickAnoValidade();//2028
        cenariostelas.escolhaAnoValidade();
        cenariostelas.setCodSeguranca("511");
