...
public class CY0004_Ativacao_DependenteTIMBlackFamilia_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Ativacao_Dependente_TIM_Black_Familia() throws InterruptedException{
	...
	// ######## DADOS COMPLEMENTARES ########
		...
		cenariostelas.setTelContato("15981110518");
	...
	// ######## ESCOLHER TITULAR OU DEPENDENTE ########
		...
		cenariostelas.numeroTitular("15981110518");
		cenariostelas.clickBotaoProsseguir();		


	// ######## PLANOS ########
		cenariostelas.clickBlackDependente();
