...
public class CY0011_Migracao_Pre_Para_Pos_Controle_Plano_VAREJO_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Migracao_Pre_Para_Pos_Controle_Plano_VAREJO() throws InterruptedException{
	...
	// ######## NOVO ATENDIMENTO ########
        ...
        ResultSet telcont = database.executeAndReturnFirstResult(ResgataCPF, conn);
        String tel = "";
        try {
            tel = telcont.getString(8);
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } DataBaseUtils.closeConnection(conn);
        cenariostelas.setTelefone(tel);
