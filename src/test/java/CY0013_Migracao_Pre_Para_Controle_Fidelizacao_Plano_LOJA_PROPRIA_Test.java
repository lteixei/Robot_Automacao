...
public class CY0013_Migracao_Pre_Para_Controle_Fidelizacao_Plano_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Migracao_Pre_Para_Controle_Fidelização_Plano_LOJA_PROPRIA() throws InterruptedException{
    ...
    // ######## INSERIR CHIP LOJA PRÓPRIA ########
     ...
     // ######## ALTERAR CADASTRO ########
        cenariostelas.setData_Alteracao_Cadastro("12102020");
        cenariostelas.clickBotaoProsseguir();
        cenariostelas.clickBotaoProsseguir();
    ...
    // ######## LIMPAR MASSA ########
        String msisdn = cenariostelas.obterTexto("label-number-choice");
        //SysteString msisdn = cenariostelas.ResgataMSISDN();
