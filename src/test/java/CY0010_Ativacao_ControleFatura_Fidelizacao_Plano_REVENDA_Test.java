...
public class CY0010_Ativacao_ControleFatura_Fidelizacao_Plano_REVENDA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_AtivacaoControleFaturaSemPortabilidade() throws InterruptedException{
    ...
    // ######## NOVO ATENDIMENTO - INSERIR TELEFONE ########
        String telcont = "15964738960";
        cenariostelas.setTelefone(telcont);
        System.out.println("Telefone:" + telcont);
    ...
    // ######## DADOS DO CLIENTE ########
        ...
        cenariostelas.setEmailCliente("lili@lili.com.br");
	...
	// ######## DADOS COMPLEMENTARES ########
		...
		cenariostelas.setOrgaoEmissor("IFP");
		cenariostelas.clickAntesUF();
		cenariostelas.clickUF();
		cenariostelas.setTelContato("1197953833");
	...
	// ######## PLANOS ########
        ...
        cenariostelas.clickFidelizacaoPlano();
        cenariostelas.clickPopup();
	...
	// ######## FIDELIZAÇÃO DE APARELHO ########
		cenariostelas.setIMEI("442994712095538");
