...
public class CY0001_Ativacao_PrePago_LOJA_PROPRIA_Test extends Cenarios_TelasPage {
    ...
    @Test
    public void test_Ativacao_De_Acesso_PrePago() throws InterruptedException {
     ...
     // ######## ENDEREÇO DO CLIENTE ########
        ...
        cenariostelas.setNomeDaRua("Jaime");
     ...
     // ######## CONT...INSERIR CHIP ########
        cenariostelas.setCHIP("89550312000106022586");
