...
public class CY0005_Ativacao_Controle_Express_REVENDA_Test extends Cenarios_TelasPage{
	...
	// ######## CARTÃO DE CRÉDITO ########
		cenariostelas.setNumeroCartao("5102996964486315");
		...
		cenariostelas.setCodSeguranca("418");
