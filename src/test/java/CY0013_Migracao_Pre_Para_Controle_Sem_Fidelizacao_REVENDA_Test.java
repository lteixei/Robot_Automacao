...
public class CY0013_Migracao_Pre_Para_Controle_Sem_Fidelizacao_REVENDA_Test extends Cenarios_TelasPage{
    ...
    private String ResgataCPF = "Select distinct prd.name,prd.part_num,prd.category_cd,prd.desc_text,ext.alias_name,ext.name as cpf,ext.X_TIPO_CLIENTE,ass.asset_num,ass.created,prd.name "
            ...
            + "and prd.desc_text like '%TIM PRÉ TOP%' "
	...
	@Test
	public void test_Migracao_Pre_Para_Controle_Sem_Fidelização_REVENDA() throws InterruptedException{
    ...
    // ######## LIMPAR MASSA ########
        ...
        String res="";
        try {
            res = JenkinsHelper.runJk_Limpar_Massa("", msisdn, chip );
        } catch (IOException e) {
                e.printStackTrace();
