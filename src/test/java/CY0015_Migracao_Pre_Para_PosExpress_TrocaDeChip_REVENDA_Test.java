...
public class CY0015_Migracao_Pre_Para_PosExpress_TrocaDeChip_REVENDA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Migracao_Pre_Para_PosExpress_TrocaDeChip_REVENDA() throws InterruptedException{
	...
	// ######## CARTÃO DE CRÉDITO ######## numero ok
		cenariostelas.setNumeroCartao("4235282154864410");//4135345113217565' - 5506597606713371
		...
		cenariostelas.setCodSeguranca("946");//298 - 397
	...
	// ######## BUSCA E INSERE TELEFONE ########
        ...
        boolean resp = database.executeInsert("UPDATE CX_NUM_INVENT SET X_VOIP_FLG = null, CNL_CODE = null,"
                ...
                conn);
        System.out.println("MSISDN :" + resp);
        DataBaseUtils.closeConnection(conn);
    ...
    // ######## ALTERAR ENDEREÇO ########
        cenariostelas.proximoEnderecoClientes2();
