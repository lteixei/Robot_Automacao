...
public class CY0016_Migracao_Pre_Para_Pos_ComTT_TrocaChip_Fidelizacao_Aparelho_Plano_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Migracao_Pre_Para_Pos_ComTT_TrocaChip_Fidelizacao_Aparelho_Plano_LOJA_PROPRIA() throws InterruptedException{
	...
	// ######## NOVO ATENDIMENTO - INSERÇÃO DO CPF ########
        ...
        // ######## INSERIR TELEFONE ########
        String telcont = "31985355240";
        cenariostelas.setTelefone(telcont);
        cenariostelas.proximoNovoAtendimento();
		

	// ######## ATENDIMENTO ########
		cenariostelas.insertNovoTel("19981110005");//19981110003
	...
	// ######## PLANOS ########
		cenariostelas.clickPlanoTimBlackB3();
