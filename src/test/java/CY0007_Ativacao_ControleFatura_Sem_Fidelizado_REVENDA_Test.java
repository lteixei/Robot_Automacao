...
public class CY0007_Ativacao_ControleFatura_Sem_Fidelizado_REVENDA_Test extends Cenarios_TelasPage{
    ...
    @Test
    public void test_Ativacao_ControleFatura_Sem_Fidelização() throws InterruptedException {
