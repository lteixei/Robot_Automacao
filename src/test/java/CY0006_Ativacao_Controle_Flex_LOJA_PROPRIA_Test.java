...
public class CY0006_Ativacao_Controle_Flex_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
	...
	private String ResgataRowId = "Select * from siebel.cx_interf_log  "
            ...
            + "ORDER BY CREATED DESC ";private String Resgata_Protocolo_Perroni = "SELECT A.key_3 AS PROTOCOLO "
                    + ",A.key_1 AS CPF "
	...
	@Test
	public void test_AtivacaoControleFatura() throws InterruptedException{
