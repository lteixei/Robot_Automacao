...
public class CY0013_Migracao_Pre_Para_Controle_Fidelizacao_Plano_Aparelho_LOJA_PROPRIA_Test extends Cenarios_TelasPage{
	...
	@Test
	public void test_Migracao_Pre_Para_Controle_Fidelização_Plano_Aparelho_LOJA_PROPRIA() throws InterruptedException{
	...
	// ######## FIDELIZAÇÃO DE APARELHO ########
        String IMEI = "332193350964724";
        cenariostelas.setIMEI(IMEI);
